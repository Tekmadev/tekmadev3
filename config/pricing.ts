...
export const tierMeta: TierMeta[] = [
  {
    ...
    features: [
      ...
      "One dashboard shows exactly where each booked call came from",
    ...
    missing: [
      ...
      "Your social media posted for you so you stay top of mind",
      "Funnels and landing pages that turn clicks into booked calls",
