...
const templates = [
  ...
  },
  {
    ...
    subject: "Your setup fee is on us (this week)",
    preheader: "Free install plus a promo code, applied automatically. Ends Sunday.",
    eyebrowText: "Limited offer",
    heading: "The setup fee is on us.",
    blocks: (k) => [
      lead("This week only, we are waiving the setup fee for new installs and applying a launch discount on top, automatically."),
      ...
      callout("Free setup + auto-applied promo", "Applied at checkout when you start this week. No code to remember."),
...
const index =
  ...
  "On-brand marketing emails that **GHL sends**. Each carries first-party tracking: a 1x1 open pixel and CTA links that route through `tekmadev.com/api/e/*`, so opens and clicks show up in the admin at **/admin/email** (owned by you, independent of GHL's own stats).\n\n" +
